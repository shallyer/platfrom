	...
	<div class="wh100 suatainMonitor-root">
		...
		<div class='commonTop clearfix'>
			<el-breadcrumb separator="/" class="comBread">
				...
				<el-breadcrumb-item>持续性监测</el-breadcrumb-item>
			</el-breadcrumb>
		</div>
		<!--选择部分  时间段+站点-->
		...
		<div class="chartRow">
			<div class="tableChart">
				<div class="wh100 animated zoomIn bg-fontColor notice_container listHeight">
			...
			<div class="others">
				<div class="others-cont wh100 animated zoomIn bg-fontColor notice_container">
					<div class="other-top">
						<div class="img-ing1 img-ing"></div>
						<div class="img-ing2 img-ing"></div>
					</div>
					<div class="siteNUM clearfix">
						<el-row :span="24">
							<el-col :span="17">站点总数</el-col>
							<el-col :span="7">{{siteAll}}</el-col>
						</el-row>
					</div>
					<div class="siteNUM clearfix">
						<el-row :span="24">
							<el-col :span="17">web漏洞</el-col>
							<el-col :span="7">{{webNum}}</el-col>
						</el-row>
					</div>
				</div>
			</div>
	...
	export default {
		data() {
			return {
				...
				Url: {
					...
					linkCode: 'http://192.168.120.208:8084/link/linkcode',
					linkTime: 'http://192.168.120.208:8084/link/linktime',
					linkpage: 'http://192.168.120.208:8084/link/linkpage',
		...
		methods: {
			...
			onSubmit() {
				var _self = this;
				_self.tableType = 1;
				_self.getWebNum(_self.commonOpt.siteId);
				_self.pieChart();
				_self.lineChart();
				_self.tableChart();
			},
...
//                                }], false),*/
			...
			getWebNum(id) {
				var _self = this;
				common_tools.AJAX('post', _self.Url.siteCount, {
					siteId: id
				}, function(data) {
					_self.webNum = data.data.webCount;
				}, function(data) {
					console.log(data);
				})
			}
