        ...
        <div class="top_nav">
            ...
            <div class="breadcrumb_nav">
                <el-breadcrumb separator="/">
                    <el-breadcrumb-item :to="{ path: '/main' }">概览</el-breadcrumb-item>
                    <el-breadcrumb-item>
                        报警信息
                    </el-breadcrumb-item>
                </el-breadcrumb>
                ...
                <el-table :data="tableData" style="width: 100%">
                    ...
                    <el-table-column label="操作" width="150" show-overflow-tooltip="ture">
                        <template scope="scope">
                            <el-button @click.native.prevent="deleteRow(scope.$index, tableData)" size="small"> 通知</el-button>
                        </template>
                    </el-table-column>
                </el-table>
            </div>
...
export default {
    data() {
        ...
        methods: {
            ...
            Initialize() {
                var _this = this;
                common_tools.AJAX('post', common_tools.interfaceurl + 'site/list', {}, function(data) {
            ...
            statisChart(siteID) {
                ...
                common_tools.AJAX('post', common_tools.interfaceurl + 'security/securityCount', {
                    "siteId": siteID,
                   "strDate":"2017-08-15 00:00:00",
                    "endDate":"2017-08-23 14:20:03",
                    "type": _this.typeN
                }, function(data) {
                	var option={
                		tooltip: {
            ...
            getList(siteID,indexs) {
                ...
                common_tools.AJAX('post', common_tools.interfaceurl + 'security/warnTable', {
                    ...
                    _this.total = data.data.pagecount*5;
